...
```{r}
barbie_post <- read.csv('/Users/huhuiying/Documents/GitHub/ComputationalTextAnalysis_Week03/Barbie_Reddit_Posts - Barbie_Reddit_Posts.csv')
```

```{r}
oppenheimer_post <- read.csv('/Users/huhuiying/Documents/GitHub/ComputationalTextAnalysis_Week03/Oppenheimer_Reddit_Posts - Oppenheimer_Reddit_Posts.csv')
```
...
barbie_record <- barbie_post%>%
  mutate(movie="barbie")
oppenheimer_record <- oppenheimer_post%>%
  mutate(movie="oppenheimer")
# bind rows to make a single dataset
Barbie_oppenheimer <- bind_rows(barbie_record, oppenheimer_record)
